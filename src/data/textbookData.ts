...
export const INITIAL_TEXTBOOK: Textbook = {
  ...
  },
  {
    ...
    "summary": "Constructing the real numbers R through constructive Iris aperture limits and convergent Cauchy sequences of rational partition grid measurements, establishing continuous flux parameters and transcendental bivector rotations without unconstructive non-denumerable infinities.",
    "sections": [
      {
